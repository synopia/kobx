...
interface EntityManager {
    ...
    fun<T> addAttribute(entity: Entity, name: String, obj: ObservableList<T>): Attribute<List<T>>
...
open class BaseEntityManager() : EntityManager {
    ...
    override fun<T> addAttribute(entity: Entity, name: String, obj: ObservableList<T>) : Attribute<List<T>> {
        return add(obj) {
